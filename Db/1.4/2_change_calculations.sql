...
-- Дата скрипта: 08.05.2016 22:45:03
...
--
-- Изменить таблицу "calculations"
--
ALTER TABLE calculations
  DROP COLUMN drawing_id,
  DROP COLUMN calculation_type_enum,
  DROP FOREIGN KEY FK_calculations_drawings_id,
  DROP INDEX FK_calculations_drawings_id;

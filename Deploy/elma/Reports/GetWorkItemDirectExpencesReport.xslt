  ...
  <xsl:template match="root">
   ...
   <Column ss:AutoFitWidth="0" ss:Width="49.5" ss:Span="6"/>
          ...
          <Row ss:Height="15.75">
            ...
            <Cell ss:StyleID="s17" ss:Formula="=R[-1]C/R[-1]C[-1]"><Data ss:Type="Number">56</Data>
            </Cell>
            <Cell ss:StyleID="s17" ss:Formula="=R[-1]C/R[-1]C[-2]">
              <Data ss:Type="Number">66</Data>
            </Cell>
            <Cell ss:StyleID="s17" ss:Formula="=R[-1]C/R[-1]C[-3]">
              <Data ss:Type="Number">57</Data>
            </Cell>
            <Cell ss:StyleID="s17" ss:Formula="=R[-1]C/R[-1]C[-4]">
              <Data ss:Type="Number">22</Data>
            </Cell>
            <Cell ss:StyleID="s25" ss:Formula="=R[-1]C/R[-1]C[-5]">
              <Data ss:Type="Number">91</Data>
            </Cell>
            <Cell ss:StyleID="s27" ss:Formula="=R[-1]C/R[-1]C[-6]">

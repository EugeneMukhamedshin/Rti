      ...
      <Worksheet ss:Name="Лист1">
        <Table x:FullColumns="1" x:FullRows="1" ss:DefaultRowHeight="15">
          ...
          <Row ss:Height="15.75">
            ...
            <Cell ss:StyleID="s16" ss:Formula="=R[-1]C/R[-1]C[-1]">
              <Data ss:Type="Number">68</Data>
            </Cell>
            <Cell ss:StyleID="s16" ss:Formula="=R[-1]C/R[-1]C[-2]">
              <Data ss:Type="Number">68</Data>
            </Cell>
            <Cell ss:StyleID="s16" ss:Formula="=R[-1]C/R[-1]C[-3]">
              <Data ss:Type="Number">68</Data>
            </Cell>
            <Cell ss:StyleID="s16" ss:Formula="=R[-1]C/R[-1]C[-4]">
              <Data ss:Type="Number">68</Data>
            </Cell>
            <Cell ss:StyleID="s16" ss:Formula="=R[-1]C/R[-1]C[-5]">
              <Data ss:Type="Number">68</Data>
            </Cell>
            <Cell ss:StyleID="s16" ss:Formula="=R[-1]C/R[-1]C[-6]">
              <Data ss:Type="Number">68</Data>
            </Cell>
          </Row>
        </Table>

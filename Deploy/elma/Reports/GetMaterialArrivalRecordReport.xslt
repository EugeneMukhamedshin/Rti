...
<xsl:stylesheet version="1.0"
    ...
    <Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
     ...
     xmlns:html="http://www.w3.org/TR/REC-html40">
      ...
      <Worksheet ss:Name="Лист1">
        <Table x:FullColumns="1" x:FullRows="1" ss:DefaultRowHeight="40">
          ...
          <Row ss:Height="21">
            <Cell ss:MergeAcross="7" ss:StyleID="s71">
              <Data ss:Type="String">Журнал прихода материалов</Data>
            </Cell>
          </Row>
          <Row>
          ...
          <Row ss:Height="30.75">
            ...
            <Cell ss:StyleID="s86">
              <Data ss:Type="String">№ СФ</Data>
            </Cell>
            <Cell ss:StyleID="s86">
              <Data ss:Type="String">Поставщик</Data>
            </Cell>
            <Cell ss:StyleID="s86">
              <Data ss:Type="String">Сумма по СФ</Data>
            </Cell>
            <Cell ss:StyleID="s86">
              <Data ss:Type="String">Дата накладной</Data>
            </Cell>
            <Cell ss:StyleID="s86">
            ...
            <Cell ss:StyleID="s86">
              <Data ss:Type="String">Передано</Data>
            </Cell>
          </Row>

          <xsl:apply-templates select="MaterialArrivalRecords/MaterialArrivalRecord" />
          ...
          <Row>
            ...
            <Cell ss:StyleID="s79"/>
            <Cell ss:StyleID="s93" ss:Formula="=SUM(R[-{count(MaterialArrivalRecords/MaterialArrivalRecord)}]C:R[-1]C)">
  ...
  <xsl:template match="MaterialArrivalRecords/MaterialArrivalRecord">
    <Row>
      <Cell ss:StyleID="s84">
        <Data ss:Type="Number">
      ...
      <Cell ss:StyleID="s84">
        <Data ss:Type="Number">
          <xsl:value-of select="@InvoiceSum"/>
        </Data>
      </Cell>
      <Cell ss:StyleID="s84">
        <Data ss:Type="String">
          <xsl:value-of select="rti:FormatDate(@WaybillDate)"/>
        </Data>
      </Cell>
      <Cell ss:StyleID="s84">
        <Data ss:Type="Number">
      ...
      <Cell ss:StyleID="s84">
        <Data ss:Type="String">
          <xsl:value-of select="MeasureUnit/@Name"/>
        </Data>
      </Cell>
      <Cell ss:StyleID="s84">
        <Data ss:Type="Number">
      ...
      <Cell ss:StyleID="s84">
        <Data ss:Type="String">
          <xsl:value-of select="@ForwardedTo"/>
        </Data>
      </Cell>
    </Row>
  </xsl:template>

        ...
        <Table x:FullColumns="1" x:FullRows="1" ss:DefaultRowHeight="15">
          ...
          <Row>
            <Cell ss:MergeAcross="8" ss:StyleID="s31">
              <Data ss:Type="String">Учет прямых затрат на отгрузку <xsl:value-of select="rti:FormatDate(Report/@StartDate, 'dd.MM.yyyy')"/> - <xsl:value-of select="rti:FormatDate(Report/@EndDate, 'dd.MM.yyyy')"/>
            </Data>
            </Cell>
          </Row>
          <Row ss:Index="3" ss:Height="45">
            ...
            <Cell ss:StyleID="s17">
              <Data ss:Type="String">Отгружено деталей, шт.</Data>
            </Cell>
            <Cell ss:StyleID="s17">
          ...
          <Row/>
          <Row ss:Height="15.75">
            <Cell ss:StyleID="s19" ss:MergeAcross="2">
            ...
            <Cell ss:StyleID="s18" ss:Formula="=SUM(RC[-5]:RC[-1])">
              <Data ss:Type="Number">68</Data>
            </Cell>
          </Row>
          <Row ss:Height="16.5">
            <Cell ss:StyleID="s19">
              <Data ss:Type="String">Затраты на единицу продукции</Data>
            </Cell>
            <Cell ss:StyleID="s18"/>
            <Cell ss:StyleID="s18"/>
            <Cell ss:StyleID="s18"></Cell>
            <Cell ss:StyleID="s18" ss:Formula="=R[-1]C/R[-1]C[-1]">
              <Data ss:Type="Number">56</Data>
            </Cell>
            <Cell ss:StyleID="s18" ss:Formula="=R[-1]C/R[-1]C[-2]">
              <Data ss:Type="Number">66</Data>
            </Cell>
            <Cell ss:StyleID="s18" ss:Formula="=R[-1]C/R[-1]C[-3]">
              <Data ss:Type="Number">57</Data>
            </Cell>
            <Cell ss:StyleID="s18" ss:Formula="=R[-1]C/R[-1]C[-4]">
              <Data ss:Type="Number">22</Data>
            </Cell>
            <Cell ss:StyleID="s26" ss:Formula="=R[-1]C/R[-1]C[-5]">
              <Data ss:Type="Number">91</Data>
            </Cell>
            <Cell ss:StyleID="s28" ss:Formula="=R[-1]C/R[-1]C[-6]">
        ...
        <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
          ...
          <Panes>
            <Pane>
              ...
              <RangeSelection>R27C9:R28C9</RangeSelection>
            </Pane>
          </Panes>
  ...
  <xsl:template match="Shipments/Shipment">
    ...
    <Row>
      <Cell ss:MergeAcross="8" ss:StyleID="s30">
        <Data ss:Type="String">Отгрузка № <xsl:value-of select="@ShipmentNumber"/> от <xsl:value-of select="rti:FormatDateTime(@ShipmentDate, 'dd.MM.yyyy')"/>
      </Data>
      </Cell>
    </Row>
    ...
    <Row ss:Height="16.5">
      <Cell ss:StyleID="s19">
        <Data ss:Type="String">Итого по отгрузке</Data>
      </Cell>
      <Cell ss:StyleID="s18"/>
      <Cell ss:StyleID="s18"/>
      <Cell ss:StyleID="s18" ss:Formula="=SUM(R[-{count(row)}]C:R[-1]C)">
      ...
      <Cell ss:StyleID="s26" ss:Formula="=SUM(R[-{count(row)}]C:R[-1]C)">
        <Data ss:Type="Number">91</Data>
      </Cell>
      <Cell ss:StyleID="s28" ss:Formula="=SUM(RC[-5]:RC[-1])">
        <Data ss:Type="Number">292</Data>
      </Cell>
    </Row>

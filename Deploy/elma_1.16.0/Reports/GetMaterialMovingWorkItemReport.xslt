...
<xsl:stylesheet version="1.0"
        ...
        <Table x:FullColumns="1" x:FullRows="1" ss:DefaultRowHeight="15">
          ...
          <Row>
            <Cell ss:MergeAcross="7" ss:StyleID="s21">
              <Data ss:Type="String">
                Учет материалов (по наряду) <xsl:value-of select="Report/@StartDate"/> - <xsl:value-of select="Report/@EndDate"/>
              </Data>
            </Cell>
          </Row>
          <Row>
          ...
          <Row ss:Height="60">
            ...
            <Cell ss:StyleID="s18">
              <Data ss:Type="String">№ наряда</Data>
            </Cell>
            <Cell ss:StyleID="s18">
  ...
  <xsl:template match="row">
    <Row>
      ...
      <Cell ss:StyleID="s19">
        <Data ss:Type="String">
          <xsl:value-of select="rti:FormatDate(@DocNumber)"/>
        </Data>
      </Cell>
      <Cell ss:StyleID="s19">
        <Data ss:Type="Number">

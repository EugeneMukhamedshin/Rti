...
namespace Rti.ViewModel.Reporting.Generator
{
    public class XslExtensions
    {
        public static string GetRepresentation(decimal number)
        {
            ...
            var arrayString = new string[4, 3] {{"миллиард", "миллиарда", "миллиардов"},
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                if (part != 0)
                {
                    if (((part - (part % 100)) / 100) != 0)
                        ...
                        {
                            case 1: appendWithDelimeter(result, "сто"); break;
                            case 2: appendWithDelimeter(result, "двести"); break;
                            case 3: appendWithDelimeter(result, "триста"); break;
                            case 4: appendWithDelimeter(result, "четыреста"); break;
                            case 5: appendWithDelimeter(result, "п€тьсот"); break;
                            case 6: appendWithDelimeter(result, "шестьсот"); break;
                            case 7: appendWithDelimeter(result, "семьсот"); break;
                            case 8: appendWithDelimeter(result, "восемьсот"); break;
                            case 9: appendWithDelimeter(result, "дев€тьсот"); break;
                        }
                    if (((part % 100) - ((part % 100) % 10)) / 10 != 1)
                    {
                        switch (((part % 100) - ((part % 100) % 10)) / 10)
                        {
                            case 2: appendWithDelimeter(result, "двадцать"); break;
                            case 3: appendWithDelimeter(result, "тридцать"); break;
                            case 4: appendWithDelimeter(result, "сорок"); break;
                            case 5: appendWithDelimeter(result, "п€тьдес€т"); break;
                            case 6: appendWithDelimeter(result, "шестьдес€т"); break;
                            case 7: appendWithDelimeter(result, "семьдес€т"); break;
                            case 8: appendWithDelimeter(result, "восемьдес€т"); break;
                            case 9: appendWithDelimeter(result, "дев€носто"); break;
                        }           
                        switch (part % 10)
                        {
                            case 1: if (i == 2) appendWithDelimeter(result, "одна"); else appendWithDelimeter(result, "один"); break;
                            case 2: if (i == 2) appendWithDelimeter(result, "две"); else appendWithDelimeter(result, "два"); break;
                            case 3: appendWithDelimeter(result, "три"); break;
                            case 4: appendWithDelimeter(result, "четыре"); break;
                            case 5: appendWithDelimeter(result, "п€ть"); break;
                            case 6: appendWithDelimeter(result, "шесть"); break;
                            case 7: appendWithDelimeter(result, "семь"); break;
                            case 8: appendWithDelimeter(result, "восемь"); break;
                            case 9: appendWithDelimeter(result, "дев€ть"); break;
                        }
                    }
                    else switch (part % 100)
                        {
                            case 10: appendWithDelimeter(result, "дес€ть"); break;
                            case 11: appendWithDelimeter(result, "одиннадцать"); break;
                            case 12: appendWithDelimeter(result, "двенадцать"); break;
                            case 13: appendWithDelimeter(result, "тринадцать"); break;
                            case 14: appendWithDelimeter(result, "четырнадцать"); break;
                            case 15: appendWithDelimeter(result, "п€тнадцать"); break;
                            case 16: appendWithDelimeter(result, "шестнадцать"); break;
                            case 17: appendWithDelimeter(result, "семнадцать"); break;
                            case 18: appendWithDelimeter(result, "восемннадцать"); break;
                            case 19: appendWithDelimeter(result, "дев€тнадцать"); break;
                        }
                if (part % 100 >= 10 && part % 100 <= 19) appendWithDelimeter(result, arrayString[i, 2]);
                else switch (part % 10)
                    {
                        case 1: appendWithDelimeter(result, arrayString[i, 0]); break;
                        case 2:
                        case 3:
                        case 4: appendWithDelimeter(result, arrayString[i, 1]); break;
                        case 5:
                        case 6:
                        case 7:
                        case 8:
                        case 9: 
                        case 0: appendWithDelimeter(result, arrayString[i, 2]); break;
                    }
                }
            }

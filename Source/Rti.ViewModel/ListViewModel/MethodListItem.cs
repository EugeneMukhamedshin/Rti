...
{
    public class MethodListItem : EntityListItem<MethodViewModel, Method>
    {
        ...
        public MethodListItem(MethodViewModel entity, IMasterDetailListViewModel ownerList, IRepositoryFactory repositoryFactory)

...
namespace Rti.Model.Repository.Interfaces
{
    public interface IReportRepository
    {
        ...
        XDocument GetDrawingShipmentsReport(DateTime startDate, DateTime endDate, int? drawingId, int? customerId);
        ...
        XDocument GetShortSalaryReport(DateTime startDate, DateTime endDate, int? employeeId);

...
namespace Rti.Model.Repository.NHibernate
{
    public class NHibernateRepositoryFactory: IRepositoryFactory
    {
        public IRepository<TEntity> GetRepository<TEntity>() where TEntity : class, IIdentifiedEntity
        {
            ...
            if (typeof(TEntity) == typeof(Rti.Model.Domain.WorkItemEmployeePackage))
                return (IRepository<TEntity>)new WorkItemEmployeePackageRepository();
            if (typeof(TEntity) == typeof(Rti.Model.Domain.WorkItemEmployeePackageMachine))
                return (IRepository<TEntity>)new WorkItemEmployeePackageMachineRepository();
		...
		public IWorkItemEmployeePackageMachineRepository GetWorkItemEmployeePackageMachineRepository() { return (IWorkItemEmployeePackageMachineRepository) GetRepository<Rti.Model.Domain.WorkItemEmployeePackageMachine>(); }
	...
	public partial class WorkItemEmployeePackageRepository : NHibernateRepository<Rti.Model.Domain.WorkItemEmployeePackage>, IWorkItemEmployeePackageRepository
    {

        protected override IQueryOver<Rti.Model.Domain.WorkItemEmployeePackage, Rti.Model.Domain.WorkItemEmployeePackage> GetDefaultQueryOver(IQueryOver<Rti.Model.Domain.WorkItemEmployeePackage, Rti.Model.Domain.WorkItemEmployeePackage> queryOver)
        {
			var result = queryOver;
			result = result.Fetch(o => o.Employee).Default;
            return result;
	...
	public partial class WorkItemEmployeePackageMachineRepository : NHibernateRepository<Rti.Model.Domain.WorkItemEmployeePackageMachine>, IWorkItemEmployeePackageMachineRepository
    {

        protected override IQueryOver<Rti.Model.Domain.WorkItemEmployeePackageMachine, Rti.Model.Domain.WorkItemEmployeePackageMachine> GetDefaultQueryOver(IQueryOver<Rti.Model.Domain.WorkItemEmployeePackageMachine, Rti.Model.Domain.WorkItemEmployeePackageMachine> queryOver)
        {
			var result = queryOver;
			result = result.Fetch(o => o.WorkItemEmployeePackage).Default;
			result = result.Fetch(o => o.Machine).Default;
            return result;
        }
    }

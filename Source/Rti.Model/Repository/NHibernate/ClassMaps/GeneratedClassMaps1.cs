...
namespace Rti.Model.Repository.NHibernate.ClassMaps
{
	...
	public partial class CalculationMap : BaseMap<Rti.Model.Domain.Calculation>
	{
		...
		private void Initialize()
		{
			...
			Map(o => o.PressCount, "press_count");
			OnInitialized();
		}
	}
	...
	public partial class RequestMap : BaseMap<Rti.Model.Domain.Request>
	{
		...
		private void Initialize()
		{
			...
			Map(o => o.IsDeleted, "is_deleted");
			Map(o => o.SpecificationNumber, "specification_number");
	...
	// The classmap for work_item_employee_package
	public partial class WorkItemEmployeePackageMap : BaseMap<Rti.Model.Domain.WorkItemEmployeePackage>
	{
		public WorkItemEmployeePackageMap()
		{
			Initialize();
		}
		...
		private void Initialize()
		{
			Table("work_item_employee_package");
			Id(o => o.Id, "id");
			Map(o => o.Date, "date");
			Map(o => o.Block, "block");
			References(o => o.Employee, "employee_id").Fetch.Join().Not.LazyLoad();
	...
	// The classmap for work_item_employee_package_machines
	public partial class WorkItemEmployeePackageMachineMap : BaseMap<Rti.Model.Domain.WorkItemEmployeePackageMachine>
	{
		public WorkItemEmployeePackageMachineMap()
		{
			Initialize();
		}
		...
		private void Initialize()
		{
			Table("work_item_employee_package_machines");
			Id(o => o.Id, "id");
			Map(o => o.FullWorkingTime, "full_working_time");
			Map(o => o.PackageWorkingTime, "package_working_time");
			References(o => o.WorkItemEmployeePackage, "work_item_employee_package_id").Fetch.Join().Not.LazyLoad();
			References(o => o.Machine, "machine_id").Fetch.Join().Not.LazyLoad();
			OnInitialized();
		}
	}

...
namespace Rti.Model.Domain
{
	...
	public partial class Drawing: IIdentifiedEntity
	{
		...
		public virtual decimal? ShruffPercent { get; set; }
	...
	// The class for employee_work_item_package
	[Table("employee_work_item_package")]
	public partial class EmployeeWorkItemPackage: IIdentifiedEntity
	{
	...
	public partial class WorkItem: IIdentifiedEntity
	{
		...
		public virtual FlowsheetMachine FlowsheetMachine { get; set; }

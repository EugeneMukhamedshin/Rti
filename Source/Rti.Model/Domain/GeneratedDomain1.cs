...
namespace Rti.Model.Domain
{
	...
	// The class for drawing_calculation_history
	[Table("drawing_calculation_history")]
	public partial class DrawingCalculationHistory: IIdentifiedEntity
	{
		[Field("id")]
		public virtual Int32 Id { get; protected set; }
	...
	public partial class Job: IIdentifiedEntity
	{
		...
		[Field("is_deleted")]
		public virtual Boolean IsDeleted { get; set; }
		[Field("access_type_enum")]
		public virtual AccessType AccessTypeEnum { get; set; }
	}
	...
	// The class for work_item_employee_package
	[Table("work_item_employee_package")]
	public partial class WorkItemEmployeePackage: IIdentifiedEntity
	{
		[Field("id")]
		public virtual Int32 Id { get; protected set; }
		[Field("date")]
	...
	// The class for work_item_employee_package_machines
	[Table("work_item_employee_package_machines")]
	public partial class WorkItemEmployeePackageMachine: IIdentifiedEntity
	{
		[Field("id")]
		public virtual Int32 Id { get; protected set; }
		...
		[Reference("work_item_employee_package_id", false)]
		public virtual WorkItemEmployeePackage WorkItemEmployeePackage { get; set; }
		[Reference("machine_id", false)]
		public virtual Machine Machine { get; set; }
	}

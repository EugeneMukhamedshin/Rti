     ...
     xmlns:html="http://www.w3.org/TR/REC-html40">
      ...
      <Worksheet ss:Name="Лист1">
        ...
        <Table ss:ExpandedColumnCount="10" x:FullColumns="1"
          ...
          <Row ss:AutoFitHeight="0">
            <Cell ss:MergeAcross="9" ss:StyleID="s62">
              <Data ss:Type="String">Приема-передачи оснастки на ответственное хранение</Data>
              <NamedCell
          ss:Name="Print_Area"/>
            </Cell>
          </Row>
          ...
          <Row ss:AutoFitHeight="0">
            <Cell>
              <Data ss:Type="String">Оснастка возвращается Исполнителем Заказчику по письменному требованию,</Data>
              <NamedCell ss:Name="Print_Area"/>
            </Cell>
          </Row>
          <Row ss:AutoFitHeight="0">
            <Cell>
              <Data ss:Type="String">с оформлением накладной М15.</Data>
              <NamedCell ss:Name="Print_Area"/>
            </Cell>
          </Row>
          <Row ss:AutoFitHeight="0">
